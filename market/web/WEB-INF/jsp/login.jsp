        ...
        <div style="height:475px;background:url(../../statics/images/banner.png) no-repeat left top">
            <div class="login-form">
                ...
                <form action="#" method="post">
                    <div class="item">
                        <label for="name"class="left"style="background:url(../../statics/images/login-icons.png) no-repeat;" ></label>
                        <input type="text" id="name" name="uname" placeholder="邮箱/用户名/已验证手机" required>
                    </div>
                    <div class="item">
                        <label for="pwd"class="left"style="background:url(../../statics/images/login-icons.png) no-repeat;background-position:-48px 0; "></label>
